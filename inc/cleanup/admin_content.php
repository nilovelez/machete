...
<div class="wrap machete-wrap machete-section-wrap">
	...
	<div class="feature-section">
		...
		<thead>
			<tr>
				<td class="manage-column column-cb check-column " ><input type="checkbox" name="check_all" id="machete_cleanup_checkall_fld" <?php if ($this->all_optimize_checked) echo 'checked' ?>></td>
				<th class="column-title manage-column column-primary"><?php _e('Remove','machete') ?></th>
				<th><?php _e('Explanation','machete') ?></th>
			</tr>
		</thead>
		...
		<thead>
			<tr>
				<td class="manage-column column-cb check-column " ><input type="checkbox" name="check_all" id="machete_cleanup_checkall_fld" <?php if ($this->all_tweaks_checked) echo 'checked' ?>></td>
				<th class="column-title manage-column column-primary"><?php _e('Remove','machete') ?></th>
				<th><?php _e('Explanation','machete') ?></th>
			</tr>
		</thead>
